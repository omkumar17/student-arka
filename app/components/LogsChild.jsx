  ...
  return (
    <div>
      ...
      <div className="mb-5 container mx-auto text-lg   flex flex-col gap-3">
        <p className=''><strong className='text-blue-600  rounded-lg p-2 m-2'>Enrollment : </strong><span className="bg-blue-600 p-2 rounded-lg mx-2 "> {logs.enrollment || session?.user?.enrollment}</span></p>
        ...
        <p className=''><strong className='text-blue-600  rounded-lg p-2 m-2'>Current Bus : </strong><span className="bg-blue-600 p-2 rounded-lg mx-2 "> {logs.current||'You are not in a bus'}</span></p>
        <p className=''><strong className='text-blue-600  rounded-lg p-2 m-2'>Status : </strong> <span className="bg-blue-600 p-2 rounded-lg mx-2 ">{logs.status || 'no records'}</span></p>
      </div>
      ...
      <div className="relative overflow-x-auto container mx-auto">
        ...
        <table className="w-full text-sm text-left rtl:text-right ">
          <thead className="text-xs  uppercase  text-md">
            <tr className='border-4 font-bold text-md'>
